var margin = { top: 50, right: 50, bottom: 50, left: 50 },
        width = document.getElementById("heat_div").offsetWidth*4/5 - margin.left - margin.right,
        height = document.getElementById("heat_div").offsetWidth*4/5 - margin.top - margin.bottom;
...
export function get_current_filters(data,actual_data) {
